...
import { UserRound, LogOut, ChevronUp, X } from 'lucide-react';
import type { CartItem, MenuItem, Operator, PaymentMethod } from '@/lib/types';
...
export default function KasirPage() {
  ...
  async function handleGantiKasir() {
  ...
  return (
    <div className="flex flex-col lg:flex-row lg:h-screen">
      ...
      >
        <div className="flex items-center justify-between mb-4 gap-2">
          ...
          {activeOperatorName && (
            <button
              ...
              className="flex items-center gap-1.5 bg-surface border border-cream-dark rounded-full pl-1 pr-3 py-1 text-xs text-espresso/70 hover:border-crema"
              title="Ganti kasir"
            >
        ...
        {checkingShift ? null : !activeOperatorName ? (
          <OperatorGate operators={operators} onUnlock={handleUnlock} />
        ) : (
